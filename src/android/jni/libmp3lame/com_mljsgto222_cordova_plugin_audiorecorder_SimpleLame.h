...
#include <jni.h>
/* Header for class com_mljsgto222_CordovaPluginAudioRecorder_SimpleLame */

#ifndef _Included_com_mljsgto222_CordovaPluginAudioRecorder_SimpleLame
#define _Included_com_mljsgto222_CordovaPluginAudioRecorder_SimpleLame
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_mljsgto222_CordovaPluginAudioRecorder_SimpleLame
 * Method:    close
 * Signature: ()V
 */
